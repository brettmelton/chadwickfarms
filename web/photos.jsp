...
<jsp:include page="/common/layout/page_header.jsp" flush="true" >	
    <jsp:param name="curpage" value="Photos" />	
</jsp:include>
...
Interested in submitting a great photo you took?  Do you have one with the units covered in snow or squirrels jumping through
the trees? Send your photos to <a href="mailto:webmaster@chadwickfarms.net?Subject=PhotoContest">webmaster@chadwickfarms.net</a>
and we'll post them on the site and credit you if you wish.
